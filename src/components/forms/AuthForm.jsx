            ...
            <div className="auth-card">
                <div className="stack stack-4">
                    ...
                    <div className="stack stack-2">
                        <h2>{isSignup ? "Join the club" : "Login to Ventara"}</h2>
                    ...
                    <form className="stack stack-4" onSubmit={handleSubmit}>
                        {isSignup && (
                            <div className="form-group">
                                ...
                                <input
                                    id="name" name="name" className="input" type="text"
                        ...
                        <div className="form-group">
                            ...
                            <input
                                id="email" name="email" className="input" type="email"
                        ...
                        {isSignup && (
                            <div className="form-group">
                                ...
                                <input
                                    id="skills" name="skills" className="input" type="text"
